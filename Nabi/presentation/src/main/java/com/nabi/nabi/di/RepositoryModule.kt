...
import com.nabi.data.repository.DiaryDbRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindsDiaryDbRepository(diaryDbRepositoryImpl: DiaryDbRepositoryImpl): DiaryDbRepository
}